...
intersecVarState ((var1,inter1):vars1)((var2,inter2):vars2)
   = (var1,(intersecVal inter1 (intersec inter1 inter2))):(intersecVarState vars1 vars2)

intersecVal::Interval->Interval->Interval
--intersecVal a Empty = a
intersecVal a b = b 
...
--Funtion that receive a more or equal interval expresion
