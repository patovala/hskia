...
removedead nodes = renumerate . filterall . filterbottom nodes 

-- iterate over the nodes until everithing is clear
filterall :: [SCFGNode] -> [SCFGNode]
filterall nodes 
        | nodes == nodes' = nodes
